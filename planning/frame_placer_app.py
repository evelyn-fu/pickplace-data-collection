...
class FramePlacerApp:
    def __init__(self, pcd):
        ...
        self.buffer_slider.set_limits(0.0, 0.09)
        ...
        # Add Clear Frames button (this removes the visualized frames but does not clear the frames list).
        self.clear_button = gui.Button("Clear Frames")
        self.clear_button.horizontal_padding_em = 0.5
        self.clear_button.vertical_padding_em = 0.5
        self.clear_button.set_on_clicked(self.on_clear_frames)
    ...
    def on_clear_frames(self):
        print("Clearing visualized frames (keeping frames list intact).")
        # Iterate through all frames that have been confirmed (names: Frame_1, Frame_2, etc.)
...
def get_frames():
    ...
    app = FramePlacerApp(o3d.io.read_point_cloud(o3d.data.PCDPointCloud().path))
