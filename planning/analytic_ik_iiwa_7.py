# taken from pete which was taken from below
#taken from https://github.com/cohnt/bimanual-ggcs-analytic-ik/blob/main/src/analytic_ik.py
...
# NOTE: We're using the LBR iiwa 7 R800
iiwa_d = np.array([
	0.34,
	0,
	0.40,
	...
	0.4,
	0,
	0.126 # This adjustment is necessary to match drake. Probably due to a flange or something?
])
